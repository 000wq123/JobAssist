...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "JobAssist" },
      { property: "og:title", content: "JobAssist — Praktikum & Teilzeitjobs in Österreich" },
      {
      ...
      { name: "twitter:image", content: "https://jobassist.at/og-image.png" },
    ],
    links: [
      {
        rel: "stylesheet",

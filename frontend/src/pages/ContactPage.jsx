...
export default function ContactPage() {
  ...
  const inputBase =
    "w-full min-h-[44px] rounded-lg border bg-[var(--color-bg-elev-1)] px-3 py-2.5 text-[14px] text-[var(--color-fg)] placeholder:text-[var(--color-fg-dim)] focus:outline-none focus:border-[var(--app-brand)]/70 transition-colors";
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <a
                    ...
                    className="mt-0.5 inline-flex items-center min-h-[44px] text-[12px] text-[var(--app-brand)] underline decoration-dotted underline-offset-2 hover:text-[var(--app-brand-hover)] transition-colors"
                  >

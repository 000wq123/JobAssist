from sqlalchemy import Index, Integer, String, Boolean, DateTime, func, ForeignKey
...
class JobAlert(Base):
    ...
    delivery_status: Mapped[str] = mapped_column(String(20), default="idle", server_default="idle")
